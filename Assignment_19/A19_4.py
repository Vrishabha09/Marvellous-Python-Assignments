...
def CpyDirs(DirName1,DirName2,Extension):
...
def main():
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == '--u' or sys.argv[1] == '--U':
            ...
            print("This file copies files with specific extension from 1 directory to other directory.")
    elif len(sys.argv) == 4:
        DirName1 = sys.argv[1]
        DirName2 = sys.argv[2]
        Extension = sys.argv[3]
        CpyDirs(DirName1,DirName2,Extension)
    else:
